...
class Ui(QtWidgets.QMainWindow):
    ...
    def initialize_widgets(self):
        ...
        'qlabel_green_target_indicator': {'widget': self.qlabel_green_target_indicator, 'nt': '/SmartDashboard/green_targets_exist', 'command': '/SmartDashboard/TurretMoveByVision/running'},
